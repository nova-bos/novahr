    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
          {
            ...
            value: `default-src 'self'; script-src ${scriptSrc}; worker-src 'self' blob:; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self' data:; connect-src 'self' https:; frame-src 'self' blob:; frame-ancestors 'self'; object-src 'none'; base-uri 'self';`,
          },
        ],
      },
    ];
