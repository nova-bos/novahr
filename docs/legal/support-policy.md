...
|---|---|---|
| Email: hello@novahr.co.za | 24/7 submission; responses in business hours | Primary channel; creates a ticket |
| In-app help and knowledge base | 24/7 | Self-service guides and FAQs |
| WhatsApp: [●] | Business hours | Growth and Scale plans |
...
- Training beyond the included onboarding sessions for your plan (additional training is available at [R●] per hour).
...
## 5. How to Get the Fastest Resolution
