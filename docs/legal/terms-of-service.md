...
(a) the accuracy, quality, and legality of Customer Data, and for having a lawful basis to process the Personal Information of its employees in the Service;
(b) configuring the Service correctly, including salary structures, deductions, leave policies, and company settings;
(c) reviewing and approving all payroll outputs before payment to employees and before submission to the South African Revenue Service ("SARS");
(d) its own statutory obligations as an employer, including PAYE, UIF, SDL, EMP201 and EMP501 submissions, and compliance with the Basic Conditions of Employment Act 75 of 1997 ("BCEA");
(e) maintaining the confidentiality of login credentials and for all activity under its Account;
(f) promptly notifying NovaHR of any suspected unauthorised access.
