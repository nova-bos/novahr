...
3.3 **Annual fees:** If you cancel an annual plan early (outside clause 3.1), the unused months are not refundable, except where:

(a) NovaHR materially breaches the agreement and fails to cure within 14 days of notice;
(b) the SLA termination right is triggered (uptime below 97% for 3 consecutive months);
(c) NovaHR discontinues the Service or materially removes core paid functionality;

in which case unused whole months are refunded pro rata.
