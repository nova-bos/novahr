...
(b) protect it with no less than reasonable care;
(c) limit disclosure to employees and advisers with a need to know, bound by equivalent confidentiality duties;
(d) not disclose pricing or proposal terms to any competitor of NovaHR;
(e) not use Confidential Information to develop, or assist another to develop, a competing product;
(f) not reverse engineer, benchmark, or test the security of the platform without written authorisation.
