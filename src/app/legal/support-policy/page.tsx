      ...
      sections={[
        {
          ...
          table: {
            ...
            rows: [
              ...
              ["Scheduled video call", "By appointment", "Enterprise plan and onboarding"],
            ],
          },
        ...
        },
        {
          ...
          bullets: [
            ...
            "Training beyond the included onboarding sessions for your plan (additional training is available on request).",
          ],
        },
        {
          ...
          paragraphs: [],
          table: {
            headers: ["Entitlement", "Standard", "Enterprise"],
            rows: [
              ["Email support", "Yes", "Yes"],
              ["Priority queue", "Standard queue", "Yes"],
              ["Onboarding", "Self-serve guides and help centre", "Dedicated onboarding"],
              ["Named account contact", "No", "Yes"],
            ],
          },
        },
        {
