...
export const metadata: Metadata = {
  ...
  description:
    "The Terms of Service that govern access to and use of the NovaHR platform, websites, and related services.",
};
  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        {
          heading: "Licence and Access Rights",
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: ["The Customer must not, and must not permit any person to:"],
          bullets: [
        ...
        {
          heading: "Customer Data, Privacy, and Security",
          paragraphs: [
        ...
        {
          heading: "Support and Service Levels",
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "15.3 Notices: Legal notices must be in writing to the addresses in the Order, with a copy by email to admin@novabos.co.za (for NovaHR) and the Customer's billing email.",
      ...
      outro="Contact: [NOVA BUSINESS OS (PTY) LTD], [registered address], admin@novabos.co.za"
    />
  );
}
