    ...
    <DialogPortal>
      ...
      >
        {noInnerPad ? (
          ...
          <div className="flex flex-col gap-4 overflow-y-auto flex-1 min-h-0 p-4">
            {children}
          </div>
        )}
        {showCloseButton && (
